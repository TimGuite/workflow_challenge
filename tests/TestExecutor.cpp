...
TEST_CASE("async executor", "[executor]") {
  SECTION("Simple workflow") {
    ...
    Cursor c1{w1};
    ExecutionResult r1 =
        asyncExecutor(c1, successfulPermissionRequest, onUpdate);
    REQUIRE(r1 == success);
  }
  ...
  SECTION("Steps with dependencies") {
    ...
    Cursor c2{w2};
    ExecutionResult r2 =
        asyncExecutor(c2, successfulPermissionRequest, onUpdate);
    REQUIRE(r2 == success);
  }
  ...
  SECTION("Parallel Tasks") {
    ...
    Cursor c3{w3};
    ExecutionResult r3 =
        asyncExecutor(c3, successfulPermissionRequest, onUpdate);
    REQUIRE(r3 == success);
  }
  ...
  SECTION("Permission not given") {
    ...
    Cursor c4{w4};
    ExecutionResult r4 =
        asyncExecutor(c4, unsuccessfulPermissionRequest, onUpdate);
    REQUIRE(r4 == failure);
  }
  ...
  SECTION("onUpdate function runs correctly") {
    ...
    const Workflow w5 =
        makeWorkflow({{"a", "Step a", successfulTask, automatic, {}},
                      ...
                      {"c", "Step c", successfulTask, manual, {"b"}}});
    Cursor c5{w5};
    asyncExecutor(c5, successfulPermissionRequest, f);
    REQUIRE(count == 3);
  }
}